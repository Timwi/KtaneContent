let SouvenirModuleData = [
	...
	{ name: "Accumulation",	id: "accumulation",	questions: ["What were the background colors at each stage?", "What was the border color?"] },
	{ name: "Adventure Game",	id: "spwizAdventureGame",	questions: ["Which items were present?"] },
	...
	{ name: "Alfa-Bravo",	id: "alfa_bravo",	questions: ["What was the last digit on the small display?"] },
	...
	{ name: "Arithmelogic",	id: "arithmelogic",	questions: ["What was the symbol on the submit button?"] },
	{ name: "Arithmetic Cipher",	id: "ArithmeticCipherModule",	questions: ["What was on each screen?"] },
	...
	{ name: "Big Circle",	id: "BigCircle",	questions: ["Which direction was the circle spinning?"] },
	...
	{ name: "Blind Maze",	id: "BlindMaze",	questions: ["What colors were the buttons?"] },
	...
	{ name: "Blockbusters",	id: "blockbusters",	questions: ["What letters were in the leftmost column at the start?"] },
	...
	{ name: "Blue Huffman Cipher",	id: "BlueHuffmanCipherModule",	questions: ["What was on each screen?"] },
	...
	{ name: "Boolean Wires",	id: "booleanWires",	questions: ["Which letters were displayed in each stage?"] },
	...
	{ name: "Boxing",	id: "boxing",	questions: ["Which contestants were shown?", "Who had which punch strength rating?"] },
	...
	{ name: "Calendar",	id: "calendar",	questions: ["What was the holiday?"] },
	...
	{ name: "Challenge & Contact",	id: "challengeAndContact",	questions: ["What were the displayed letters?"] },
	...
	{ name: "Cheat Checkout",	id: "kataCheatCheckout",	questions: ["What was the cryptocurrency?", "Which websites got hacked?"] },
	{ name: "Cheep Checkout",	id: "cheepCheckout",	questions: ["Which bird sounds could be heard?"] },
	...
	{ name: "Coffeebucks",	id: "coffeebucks",	questions: ["What was the last customer’s preferred sugar content, time of day, stress level, and size?"] },
	{ name: "Color Addition",	id: "colorAddition",	questions: ["What were the three numbers?"] },
	{ name: "Color Braille",	id: "ColorBrailleModule",	questions: ["What color was each dot?"] },
	...
	{ name: "Colored Switches",	id: "ColoredSwitchesModule",	questions: ["What was the initial position of the switches?"] },
	{ name: "Colorful Dials",	id: "colorfulDials",	questions: ["What were the numbers and their colors on the displays when the dials were in their initial calculated configurations?", "What was each digit and its color on the large display?", "What order was the color strip?"] },
	...
	{ name: "Coordinates",	id: "CoordinatesModule",	questions: ["What was the grid size?"] },
	...
	{ name: "Creation",	id: "CreationModule",	questions: ["What was the weather condition on the first day?"] },
	{ name: "Crimson Cipher",	id: "crimsonCipher",	questions: ["What was on each screen?"] },
	{ name: "Critters",	id: "CrittersModule",	questions: ["What was the color?"] },
	{ name: "Cruel Binary",	id: "CruelBinary",	questions: ["What was the displayed word?"] },
	{ name: "Cruel Keypads",	id: "CruelKeypads",	questions: ["What symbols were on the keys in each stage?", "What was the color of the bar in each stage?"] },
	{ name: "The cRule",	id: "the_cRule",	questions: ["Which cells were prefilled at the start?"] },
	...
	{ name: "Dialtones",	id: "xelDialtones",	questions: ["What was the received word?"] },
	...
	{ name: "Digital Dials",	id: "digitalDials",	questions: ["What numbers were on the displays when the dials were in their initial calculated positions?", "What number was on the large display?"] },
	{ name: "Dimension Disruption",	id: "dimensionDisruption",	questions: ["What were the visible characters?"] },
	{ name: "Directional Button",	id: "directionalButton",	questions: ["What were the button’s color and label in each stage?"] },
	...
	{ name: "Divided Squares",	id: "DividedSquaresModule",	questions: ["What color was shown when the correct square was pressed?"] },
	{ name: "DNA Mutation",	id: "DNAMutation",	questions: ["What were the DNA strands’ colors?", "What were the given nucleotides’ letters and colors?"] },
	{ name: "Doofenshmirtz Evil Inc.",	id: "doofenshmirtzEvilIncModule",	questions: ["What jingles played?", "What images were shown?"] },
	{ name: "Double Arrows",	id: "doubleArrows",	questions: ["What was the starting position?"] },
	...
	{ name: "Double Expert",	id: "doubleExpert",	questions: ["What was the starting key number?"] },
	{ name: "Double Listening",	id: "doubleListening",	questions: ["What sounds played?"] },
	{ name: "Double Screen",	id: "doubleScreenModule",	questions: ["What colors were the screens in each stage?"] },
	{ name: "Dr. Doctor",	id: "DrDoctorModule",	questions: ["Which diseases and symptoms were listed?"] },
	{ name: "Dragon Energy",	id: "dragonEnergy",	questions: ["What was the indicator color?"] },
	{ name: "Dreamcipher",	id: "ksmDreamcipher",	questions: ["What were the displayed glyphs?", "What was the initial binary string?"] },
	{ name: "The Duck",	id: "theDuck",	questions: ["What was the color of the curtain?"] },
	...
	{ name: "Eight",	id: "eight",	questions: ["What was the last digit on the small display?", "What was the position of the last broken digit?", "What was the last displayed number?"] },
	...
	{ name: "Etterna",	id: "etterna",	questions: ["What color was each arrow?"] },
	{ name: "Exoplanets",	id: "exoplanets",	questions: ["Which directions were the planets orbiting the star?"] },
	...
	{ name: "Finite Automata",	id: "FiniteAutomataModule",	questions: ["What were the relevant regexes?"] },
	...
	{ name: "Following Orders",	id: "FollowingOrders",	questions: ["What was the last sequence of shouts?", "What was the starting position?"] },
	{ name: "Forest Cipher",	id: "forestCipher",	questions: ["What was on each screen?"] },
	{ name: "Forget Any Color",	id: "ForgetAnyColor",	questions: ["What were the large display’s, gear’s, and nixies’ numbers in each stage?", "What were the cylinders’ and gear’s colors in each stage?"] },
	...
	{ name: "Forget The Colors",	id: "ForgetTheColors",	questions: ["What were the large display’s, gear’s, and nixies’ numbers in each stage?", "What were the cylinders’ and gear’s colors in each stage?"] },
	{ name: "Forget This",	id: "forgetThis",	questions: ["What was the displayed character in each stage?", "What was the LED color in each stage?"] },
	{ name: "Forget’s Ultimate Showdown",	id: "ForgetsUltimateShowdownModule",	questions: ["What was the initial number?", "What were the encryption methods used?"] },
	...
	{ name: "Giants Cipher",	id: "GiantsCipher",	questions: ["What was the displayed keyword?"] },
	...
	{ name: "The Great Void",	id: "greatVoid",	questions: ["What were the symbols and colors?"] },
	...
	{ name: "Gridlock",	id: "GridlockModule",	questions: ["What was the starting color?", "What was the starting position?"] },
	...
	{ name: "Halli Galli",	id: "halliGalli",	questions: ["Which fruit were there five of?", "What were the relevant counts?"] },
	{ name: "Hereditary Base Notation",	id: "hereditaryBaseNotationModule",	questions: ["What was the number on the bottom display?"] },
	{ name: "The Hexabutton",	id: "hexabutton",	questions: ["What color was the button when held?", "What Morse Code letter was transmitted?"] },
	...
	{ name: "Horrible Memory",	id: "horribleMemory",	questions: ["What were the colors and labels of each button in each stage?", "What digit was displayed in each stage?"] },
	{ name: "Human Resources",	id: "HumanResourcesModule",	questions: ["Which employees and applicants were present?", "Which descriptors were shown in red and green?"] },
	{ name: "Hunting",	id: "hunting",	questions: ["Which pictograms were displayed?"] },
	...
	{ name: "The Hyperlink",	id: "hyperlink",	questions: ["What was the hyperlink?"] },
	...
	{ name: "Infinite Loop",	id: "InfiniteLoop",	questions: ["What was the Morse code?"] },
	{ name: "Ingredients",	id: "ingredients",	questions: ["Which ingredients were listed?"] },
	...
	{ name: "IPA",	id: "ipa",	questions: ["What sound was played?"] },
	{ name: "The iPhone",	id: "iPhone",	questions: ["What was the PIN?"] },
	{ name: "The Jewel Vault",	id: "jewelVault",	questions: ["Which wheel spun another wheel, and which one did it spin?"] },
	...
	{ name: "Lempel-Ziv Cipher",	id: "LempelZivCipherModule",	questions: ["What was on each screen?"] },
	...
	{ name: "Logic Gates",	id: "logicGates",	questions: ["What were logic gates A-D?"] },
	...
	{ name: "M&Ns",	id: "MandNs",	questions: ["What were the labels on the buttons and their colors?"] },
	...
	{ name: "Mahjong",	id: "MahjongModule",	questions: ["What was the bottom-left tile?"] },
	...
	{ name: "Mashematics",	id: "mashematics",	questions: ["What were the numbers in the equation?"] },
	...
	{ name: "Misordered Keys",	id: "misorderedKeys",	questions: ["What were the labels, their colors, and the colors of the keys?", "Which key was K?"] },
	...
	{ name: "Monsplode Trading Cards",	id: "monsplodeCards",	questions: ["What were the names and print versions of the three cards in your hand before the final trade/keep?"] },
	...
	{ name: "Morse-A-Maze",	id: "MorseAMaze",	questions: ["What were the starting and ending locations?", "What was the Morse code word played?"] },
	{ name: "Morsematics",	id: "MorseV2",	questions: ["What were the received letters?"] },
	{ name: "Mouse In The Maze",	id: "MouseInTheMaze",	questions: ["What color was the torus?"] },
	...
	{ name: "Mystery Module",	id: "mysterymodule",	questions: ["Which module was the first requested to be solved?"] },
	{ name: "Mystic Square",	id: "MysticSquareModule",	questions: ["What digit was initially in the center?"] },
	{ name: "N&Ns",	id: "NandNs",	questions: ["What were the labels in stage 2 and 3?", "What was the missing color in stage 3?"] },
	...
	{ name: "The Necronomicon",	id: "necronomicon",	questions: ["What were the chapter numbers?"] },
	...
	{ name: "Noise Identification",	id: "noiseIdentification",	questions: ["What was the first displayed noise type?"] },
	...
	{ name: "Not Connection Check",	id: "notConnectionCheck",	questions: ["What were the flashing symbols?"] },
	{ name: "Not Coordinates",	id: "notCoordinates",	questions: ["What was the initial shape in the second stage?"] },
	...
	{ name: "Not Morse Code",	id: "NotMorseCode",	questions: ["What were the transmitted words?"] },
	{ name: "Not Morsematics",	id: "notMorsematics",	questions: ["What were the transmitted letters?"] },
	{ name: "Not Murder",	id: "notMurder",	questions: ["What were the first suspect, weapon, and room in the sequence?"] },
	...
	{ name: "Not Who’s on First",	id: "NotWhosOnFirst",	questions: ["What were the first four display words?"] },
	...
	{ name: "Old AI",	id: "SCP079",	questions: ["What was the group/sub-group of the displayed numbers?"] },
	...
	{ name: "Palindromes",	id: "palindromes",	questions: ["What number was on the display?"] },
	...
	{ name: "Password Destroyer",	id: "pwDestroyer",	questions: ["What was the 2FAST™ value?"] },
	...
	{ name: "Phosphorescence",	id: "Phosphorescence",	questions: ["What colors were the buttons?", "What was the offset?", "What was the decrypted word?"] },
	{ name: "Pickup Identification",	id: "PickupIdentification",	questions: ["What pickups were shown?"] },
	{ name: "Pictionary",	id: "pictionaryModule",	questions: ["What were the colors of the pixels?"] },
	...
	{ name: "Pixel Cipher",	id: "pixelcipher",	questions: ["What were the displayed numbers?"] },
	{ name: "Placeholder Talk",	id: "placeholderTalk",	questions: ["What was the entire first phrase?"] },
	{ name: "Placement Roulette",	id: "PlacementRouletteModule",	questions: ["What were the character, track, and vehicle listed?"] },
	{ name: "Planets",	id: "planets",	questions: ["What was the planet shown?", "What was the color for each strip?"] },
	{ name: "Playfair Cipher",	id: "Playfair",	questions: ["What was the encrypted message?", "What color was the screen?"] },
	...
	{ name: "Pokémon Sprite Cipher",	id: "PokemonSpriteCipherModule",	questions: ["What was on each screen?"] },
	...
	{ name: "Quadrants",	id: "Quadrants",	questions: ["What was on each button in each stage?"] },
	...
	{ name: "Recorded Keys",	id: "recordedKeys",	questions: ["What were the labels, their colors, and the colors of the keys in each stage used to calculate both A and B?", "Which sounds were played by the keys in each stage used to calculate A?"] },
	...
	{ name: "Reformed Role Reversal",	id: "ReformedRoleReversal",	questions: ["What base was the seed in?", "What was the lookup number?"] },
	...
	{ name: "Reordered Keys",	id: "reorderedKeys",	questions: ["What were the labels, their colors, and the colors of the keys initially in each stage?"] },
	{ name: "Retirement",	id: "retirement",	questions: ["Which houses were on offer, but not chosen by Bob?"] },
	{ name: "Reverse Morse",	id: "reverseMorse",	questions: ["What were the displayed symbols and their colors?"] },
	...
	{ name: "Role Reversal",	id: "roleReversal",	questions: ["What was the seed?"] },
	{ name: "RPS Judging",	id: "RPSJudging",	questions: ["What were the gestures in each round?"] },
	...
	{ name: "Safety Square",	id: "safetySquare",	questions: ["What were the displayed digits?", "What was displayed on the white diamond?"] },
	{ name: "The Samsung",	id: "theSamsung",	questions: ["What was the language of the equation in Duolingo?", "What were the coordinates in Google Maps?", "What were the symbols and their colors in the cycle in Photomath?", "What was the starting symbol in Photomath?", "What song was played in Spotify?", "What was the Braille pattern in Discord?"] },
	...
	{ name: "Scalar Dials",	id: "scalarDials",	questions: ["What were the notes on the displays and their colors when the dials were in their initial calculated positions?", "What were the notes on the large display?", "Which scales were played by each dial?"] },
	...
	{ name: "Semamorse",	id: "semamorse",	questions: ["What were the Morse and semaphore letters and color used for the starting value?"] },
	...
	{ name: "Simon Said",	id: "simonSaidModule",	questions: ["Which colors flashed in the final sequence?"] },
	...
	{ name: "Simon Simons",	id: "simonSimons",	questions: ["Which buttons flashed?"] },
	...
	{ name: "Simon Stages",	id: "simonStages",	questions: ["What color was the indicator in each stage?"] },
	...
	{ name: "Simon Stores",	id: "simonStores",	questions: ["Which colors flashed in the final sequence?"] },
	{ name: "Simon Subdivides",	id: "simonSubdivides",	questions: ["What colors were the cells that subdivided?"] },
	{ name: "Simon Supports",	id: "simonSupports",	questions: ["What tie colors flashed for each topic?"] },
	{ name: "Simon Swizzles",	id: "simonSwizzles",	questions: ["Where were ON and OFF?", "What was the hidden binary number?"] },
	{ name: "Simon’s On First",	id: "simonsOnFirst",	questions: ["Which colours were added in each stage?"] },
	{ name: "Simon’s Star",	id: "simonsStar",	questions: ["Which colors flashed?"] },
	...
	{ name: "Small Circle",	id: "smallCircle",	questions: ["How much did the sequence shift by?", "Which wedge made the different noise in the beginning?"] },
	...
	{ name: "Sonic & Knuckles",	id: "sonicKnuckles",	questions: ["Which monitor and badnik were shown?"] },
	{ name: "Sonic the Hedgehog",	id: "sonic",	questions: ["Which sound was played by each screen?", "What were the pictures?"] },
	{ name: "Sorting",	id: "sorting",	questions: ["Which sorting algorithm was used?"] },
	...
	{ name: "Stacked Sequences",	id: "stackedSequences",	questions: ["What flashes appeared in the combined sequence?"] },
	...
	{ name: "The Swan",	id: "theSwan",	questions: ["How many times was the system reset?"] },
	...
	{ name: "Symbolic Coordinates",	id: "symbolicCoordinates",	questions: ["Which symbols were present in each stage?"] },
	...
	{ name: "Synchronization",	id: "SynchronizationModule",	questions: ["Where was the fastest light?", "What was the speed rating of the center light?"] },
	...
	{ name: "Thinking Wires",	id: "thinkingWiresModule",	questions: ["What were the wire colors in the first stage?", "What was the display number?"] },
	...
	{ name: "Thirty One",	id: "thirtyOne",	questions: ["What were the first cards in each stage?"] },
	...
	{ name: "Toxic Crystals",	id: "ToxicCrystals",	questions: ["What letter was written on the casing when solving?"] },
	...
	{ name: "T-Words",	id: "tWords",	questions: ["What were the words?"] },
	{ name: "UFO Satellites",	id: "UfoSatellites",	questions: ["Which numbers were present?"] },
	...
	{ name: "Unfair Cipher",	id: "unfairCipher",	questions: ["What was the encrypted message?"] },
	{ name: "Unfair’s Cruel Revenge",	id: "unfairsRevengeCruel",	questions: ["What was the encrypted message?", "What digits corresponded to the ciphers used?"] },
	{ name: "Unfair’s Revenge",	id: "unfairsRevenge",	questions: ["What was the encrypted message?"] },
	{ name: "Unicode",	id: "UnicodeModule",	questions: ["What were the symbols?"] },
	...
	{ name: "Unown Cipher",	id: "UnownCipher",	questions: ["What were the stats on the displays?"] },
	...
	{ name: "Wavetapping",	id: "Wavetapping",	questions: ["What was the color in the first two stages?"] },
	...
	{ name: "Wire Ordering",	id: "kataWireOrdering",	questions: ["What were the colors and numbers on the displays?"] },
	{ name: "Wire Sequence",	id: "WireSequence",	questions: ["How many wires of each color were there?"] },
	{ name: "Wolf, Goat, and Cabbage",	id: "wolfGoatCabbageModule",	questions: ["Which creatures were present?"] },
	{ name: "Word Count",	id: "wordCount",	questions: ["What was the displayed number?"] },
	{ name: "Working Title",	id: "workingTitle",	questions: ["What was on the display?"] },
	{ name: "The World’s Largest Button",	id: "WorldsLargestButton",	questions: ["What color(s) was the button before and while it was held for step 1?", "What label was on the button?"] },
	...
	{ name: "XmORse Code",	id: "xmorse",	questions: ["What numbers were transmitted?"] },
	{ name: "xobekuJ ehT",	id: "xobekuj",	questions: ["What song was played?"] },
	{ name: "X-Ray",	id: "XRayModule",	questions: ["What symbols were scanned?"] },
	...
	{ name: "Yellow Huffman Cipher",	id: "YellowHuffmanCipherModule",	questions: ["What was on each screen?"] },
	...
	{ name: "Zoni",	id: "lgndZoni",	questions: ["What were the words?"] },
];
